...
CREATE TABLE `hy_devices` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='设备表';
...
INSERT INTO `hy_devices` VALUES ('28', '009', '灯泡44', '0', '3', null, '1', '2016-04-05 21:56:05', '2016-04-06 20:40:44');
...
INSERT INTO `hy_home` VALUES ('3', '中国', '广东省-广州市-海珠区', '1', '2', null, null, '2016-04-02 16:19:23', null, '1', null);
INSERT INTO `hy_home` VALUES ('4', '中国', '广东省-广州市-市辖区', '1', null, null, null, '2016-04-02 16:20:40', null, '1', null);
INSERT INTO `hy_home` VALUES ('8', '中国', '广东省-广州市-市辖区', '7', null, null, null, '2016-04-02 16:33:20', null, '1', null);
INSERT INTO `hy_home` VALUES ('11', '中国', '广东省-广州市-花都区-什么鬼地区', '7', null, null, null, '2016-04-09 17:25:26', null, '1', null);
...
CREATE TABLE `hy_resetpwd` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='用户建议休息表';
...
CREATE TABLE `hy_restrecord` (
  ...
  `recordTime` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='休息记录表';
...
-- Records of hy_user
-- ----------------------------
INSERT INTO `hy_user` VALUES ('1', 'admin', 'c4ca4238a0b923820dcc509a6f75849b', '2016-04-24 20:58', '1', '2016-03-26 00:00:00', '659174520@qq.com', '2016-03-08', '-1', '2', '2016-04-03 20:52:36', '1', null, 'dist/img/upload/1/201604032052369406.png', '13726229081', '', '1', '你不傻么？是么');
INSERT INTO `hy_user` VALUES ('2', 'adminB', 'c4ca4238a0b923820dcc509a6f75849b', '2016-03-19 11:02', '1', '2016-03-26 00:00:00', null, '2016-03-08', null, null, null, null, null, 'dist/img/user2-160x160.jpg', null, '270B48E1715D8231EF99BAB5428B555E', '1', null);
INSERT INTO `hy_user` VALUES ('31', 'huige', 'c4ca4238a0b923820dcc509a6f75849b', '2016-04-24 20:39', '1', '2016-04-08 17:27:12', '232@qq.com', '2013-11-11', '3', '9', null, null, null, 'dist/img/user2-160x160.jpg', '15312312321', '', '1', '你不傻么？是么');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost`  VIEW `tip_news` AS SELECT COUNT(u.registerTime) AS uNum,COUNT(h.recordTime) AS hNum ,COUNT(d.deviceName) AS dNum 
FROM hy_user AS u
LEFT JOIN hy_home AS h ON DATE_FORMAT(h.recordTime,'%Y-%m-%d')=(SELECT CURDATE()) 
LEFT JOIN hy_devices as d ON DATE_FORMAT(d.recordTime,'%Y-%m-%d')=(SELECT CURDATE()) 
WHERE DATE(u.registerTime)=(SELECT CURDATE()) ;
