...
%>
 ...
 <header class="main-header">
        <!-- Logo -->
        <a href="page/foreground/device/myDevices.jsp" class="logo">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="page/foreground/personcenter.jsp" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="page/foreground/personcenter.jsp" class="btn btn-default btn-flat">个人信息</a>
                    </div>
